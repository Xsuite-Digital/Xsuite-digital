...
//           {/* Services */}
//           <div className="col-span-1 md:col-span-2 flex flex-col items-start text-start ">
...
//               <li className="flex  space-x-3 text-gray-300 hover:text-white duration-300 ease-in-out">
//                 <a
...
//                   className="flex items-center space-x-3 "
//                 >
//                   <Icon icon="ri:instagram-fill" className="h-6 w-6 " />
//                   <span>Instagram</span>
//                 </a>
//               </li>
//               <li className="space-x-3 text-gray-300 hover:text-white duration-300 ease-in-out">
//                 <a
...
//                   className="flex items-center space-x-3"
//                 >
//                   <Icon icon="bi:linkedin" className="h-6 w-6 " />
//                   <span>LinkedIn</span>
//                 </a>
//               </li>
//             </ul>
