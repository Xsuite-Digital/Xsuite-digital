...
const ExpertiseCard = ({ title, icon }) => {
  return (
    <div className="flex flex-col items-center p-6 rounded-lg transition-transform duration-300 hover:shadow-lg hover:border-orange-500 hover:border-2 bg-white cursor-pointer group transform will-change-transform hover:scale-105"
