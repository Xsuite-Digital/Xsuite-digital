...
//       <div className="flex flex-col lg:flex-row items-center justify-between w-full max-w-6xl gap-8 lg:gap-16 bg-gray-900 rounded-xl p-6 lg:p-12 shadow-lg">
//         <div className="relative w-full lg:w-1/2">
//           <img
//             src={image}
//             alt={title}
//             className="rounded-lg shadow-lg object-contain bg-opacity-80 w-full h-64 lg:h-96"
//           />
    ...
    <div className="bg-black text-white flex flex-col items-center p-8 lg:p-16">
      <div className="flex flex-col lg:flex-row items-center justify-between mt-5 w-full max-w-6xl gap-8 lg:gap-16 bg-gray-900 rounded-xl p-6 lg:p-12 shadow-lg relative">
        ...
        <Link
          ...
          className="absolute top-4 left-4 text-white hover:text-orange-500 transition duration-300 flex items-center"
        >
        ...
        <div className="relative w-full lg:w-1/2">
          <img
            src={image}
            alt={title}
            className="rounded-lg shadow-lg   object-full bg-opacity-80 w-full h-64 lg:h-96"
          />
        </div>
