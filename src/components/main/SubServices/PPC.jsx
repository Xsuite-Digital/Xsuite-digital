  ...
  >
        ...
        <div className="w-full lg:w-2/3 flex flex-col justify-center">
          <h1 className="text-3xl lg:text-4xl font-extrabold mb-4">
           PPC
            <span className="text-orange-500 ml-2">(Pay-Per-Click)</span> Services
          </h1>
 ...
 <div className="bg-black w-full max-w-6xl  mt-0 rounded-lg shadow-lg p-8 sm:p-10 lg:p-16 lg:grid lg:grid-cols-2 lg:gap-10">
  ...
  <div className="flex flex-col justify-center">
    ...
    <ul className="text-sm lg:text-lg text-gray-300   gap-y-4 gap-x-8">
            {[
             "Targeted Traffic: Drive relevant visitors to your site with effective Google PPC campaigns.",
             "Maximized ROI: Optimize your campaigns for the highest return on investment.",
             "Conversion Optimization: Design and optimize landing pages to boost conversion rates.",
             "Measurable Results: Track and refine PPC campaigns for continuous improvement and success.",
  ...
  <img
    src="/ppc.webp"
    alt="Example Image"
    class="w-[600px] h-[300px] object-cover transition-transform duration-500 group-hover:scale-110"
  /> 
    <motion.div
                className="absolute -right-8 -bottom-8 bg-orange-500 rounded-xl p-4 shadow-lg w-48"
                initial={{ opacity: 0, y: 20 }}
