...
const GSConsole= () => {
  ...
  return (
    <div className="bg-black text-white flex flex-col items-center px-4 py-8 sm:px-6 lg:px-16 lg:gap-12">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between w-full max-w-6xl gap-8 lg:gap-16 bg-black rounded-xl p-6 lg:p-12 shadow-lg relative">
        ...
        {/* Left - Image Section */}
        <div class="group relative w-full max-w-sm overflow-hidden rounded-lg shadow-lg">
  <img
    src="/SC.webp"
    alt="Example Image"
  ...
  <div
    class="absolute inset-0 bg-white/10 transition-all duration-300 transform scale-x-0 origin-left group-hover:scale-x-100"
  ></div>
  <div
    class="absolute inset-0 flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-opacity duration-500"
  >
        ...
        <div className="w-full lg:w-2/3 flex flex-col justify-center">
          <h1 className="text-3xl lg:text-4xl font-extrabold mb-4">
           Google
            <span className="text-orange-500 ml-2">Search Console</span> Services
          </h1>
          <p className="text-gray-300 text-sm lg:text-lg mb-6">
            Maximize your brand's reach with our comprehensive digital marketing strategies.
          </p>
    ...
    <p className="text-gray-300 pl-20 pr-20 text-sm sm:text-base leading-relaxed">
      Xsuite Digital offers cutting-edge Digital Marketing Services designed to enhance your online presence and amplify your brand's digital footprint. 
      We specialize in creating and managing data-driven marketing campaigns that drive engagement, boost conversions, and foster meaningful connections 
      with your target audience. Our expertise includes SEO, SMM, and PPC advertising, ensuring your business thrives in the competitive digital landscape. 
      With a focus on measurable results and innovative strategies, Xsuite Digital helps your brand achieve sustainable growth and stand out in today's 
      dynamic online market.
    </p>
    </div>
 ...
 <div className="bg-black w-full max-w-6xl  mt-0 rounded-lg shadow-lg p-8 sm:p-10 lg:p-16 lg:grid lg:grid-cols-2 lg:gap-10">
  ...
  <div className="flex flex-col justify-center">
    <h1 className="text-3xl lg:text-4xl font-extrabold text-white mb-6">
      Our <span className="text-orange-500">Services</span> <br /> Expertise
    </h1>
    <ul className="text-sm lg:text-lg text-gray-300   gap-y-4 gap-x-8">
            {[
             "Search Performance Insights: Monitor your website's visibility in Google search results.",
             "SEO Optimization: Identify and fix issues that hinder search engine performance.",
             "Website Audits: Conduct thorough audits to ensure optimal website performance",
             "Improved Rankings: Enhance your website's search engine optimization for better results",
  ...
  <div
    class="absolute inset-0 bg-black/10 transition-all duration-300 transform scale-x-0 origin-left group-hover:scale-x-100"
  ></div>
  <div
    class="absolute inset-0 flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-opacity duration-500"
  > </div>
  ...
  <h2 className="text-2xl lg:text-3xl font-bold text-center text-orange-500 mb-">
    ...
    {cards.map((card, index) => (
      ...
      >
        ...
        <div className="absolute w-full -top-6  flex items-center justify-start  border-gray-300 bg-black">
          {React.createElement(card.icon, { className: "p-2 text-gray-300 w-12 h-12  text-orange-500 rounded-full border-dotted border-2" })}
        </div>
        {/* Card Title */}
        <h1 className="text-xl font-extrabold mt-8 mb-4 text-left" >{card.title}</h1>
        {/* Card Content */}
