      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 lg:relative items-center  sm:p-8   font-[sans-serif]">
        <div className="bg-black p-8  w-96 h-[70vh]  rounded-l-xl ">
          ...
          <ul className="flex mt-8  space-x-4">
            <li className="  h-12 w-12 rounded-full flex items-center justify-center shrink-0">
        ...
        <div className="bg-[#7E7E7E] p-7  rounded-r-xl h-[70vh]  lg:absolute left-[36%]">
          <form className="mt-8 h-96 space-y-4 ">
            <input
              type="text"
              placeholder="Name"
              className="w-full rounded-lg py-3 px-4 text-gray-800 text-sm focus:outline-none  "
            />
            <input
              type="email"
              placeholder="Email"
            ...
            <textarea
              placeholder="Message"
              rows="6"
              className="w-full rounded-lg px-4 text-gray-800 text-sm pt-3 focus:outline-none "
            ></textarea>
            <button
              type="button"
              className="text-white bg-black tracking-wide rounded-lg text-sm px-4 py-3 flex items-end justify-between  !mt-1"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16px"
