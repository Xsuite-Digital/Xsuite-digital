...
const Contact = () => {
  ...
  return (
    <div class="mt-28 max-w-6xl   max-lg:max-w-2xl mx-auto   ">
    <div class="grid lg:grid-cols-2 grid-cols-1 lg:relative items-center  sm:p-8   font-[sans-serif]">
        <div className="bg-black p-8 xl w-96 h-[70vh] rounded-xl lg:rounded-r-xl">
            ...
            <ul class="mt-12 space-y-8">
                <li class="flex items-center">
                    ...
                    <a href="javascript:void(0)" class="text-white text-md ml-4">
                        info@xsuite.digial
                    </a>
                </li>
                <li class="flex items-center">
            ...
            <ul class="flex mt-8  space-x-4">
                <li class="  h-12 w-12 rounded-full flex items-center justify-center shrink-0">
        ...
        <div class="bg-[#7E7E7E] p-7 rounded-xl lg:rounded-r-xl h-[70vh]  lg:absolute left-[36%]">
           

            <form class="mt-8 h-96 space-y-4 ">
                <input type='text' placeholder='Name'
                    class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm focus:outline-none  " />
                <input type='email' placeholder='Email'
                    class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm focus:outline-none  " />
                <input type='text' placeholder='Subject'
                    class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm focus:outline-none  " />
                <textarea placeholder='Message' rows="6"
                    class="w-full rounded-lg px-4 text-gray-800 text-sm pt-3 focus:outline-none "></textarea>
                <button type='button'
                    class="text-white bg-black tracking-wide rounded-lg text-sm px-4 py-3 flex items-end justify-between  !mt-1">
